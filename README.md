...
- این برنامه برای یادگیری بیشتر و ipsec نوشته شده و اضافه شده است , در حال بهبودی میباشد. اگر دوست داشتید استفاده کنید
- در حال حاضر من از این برنامه برای گیم آنلاین هم استفادع میکنم.
- اسگریپت هم برایش میسازم.
